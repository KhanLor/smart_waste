...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
    if ($_POST['action'] === 'update_profile') {
        ...
        try {
            ...
            $stmt = $conn->prepare("
                UPDATE users 
                SET email_notifications = ?, sms_notifications = ?, updated_at = CURRENT_TIMESTAMP
                WHERE id = ?
            ");
            $stmt->bind_param("iii", $email_notifications, $sms_notifications, $user_id);
            $stmt->execute();

            // Store notification preferences in settings table or user_preferences
            $stmt = $conn->prepare("
...
try {
    ...
    if ($stmt) {
        ...
        while ($pref = $preferences->fetch_assoc()) {
            $notification_preferences[$pref['preference_key']] = $pref['preference_value'];
        }
    }
} catch (Exception $e) {
...
try {
    $stmt = $conn->prepare("SELECT COUNT(*) as total FROM waste_reports WHERE DATE(created_at) >= DATE_SUB(CURDATE(), INTERVAL 30 DAY)");
    if ($stmt) {
        $stmt->execute();
        $reports_30_days = $stmt->get_result()->fetch_assoc()['total'];
    }
} catch (Exception $e) {
            ...
            <div class="col-md-9 col-lg-10">
                <div class="p-4">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <div class="text-end">
                            <div class="h4 text-danger mb-0"><?php echo $reports_30_days; ?></div>
                            <small class="text-muted">Reports (30 days)</small>
                        </div>
                    </div>
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="card stat-card">
                                <div class="card-body text-center">
                                    ...
                                    <h4 class="mb-1"><?php echo $total_residents; ?></h4>
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="card stat-card">
                                <div class="card-body text-center">
                                    ...
                                    <h4 class="mb-1"><?php echo $active_schedules; ?></h4>
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="card stat-card">
                                <div class="card-body text-center">
                                    ...
                                    <h4 class="mb-1"><?php echo $reports_30_days; ?></h4>
                        ...
                        <div class="col-md-9">
                            <div class="tab-content">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form method="POST">
                                                ...
                                                <div class="mb-3">
                                                    <div class="form-check form-switch">
                                                        <input class="form-check-input" type="checkbox" id="report_alerts" name="report_alerts" <?php echo $notification_preferences['report_alerts'] ? 'checked' : ''; ?>>
                                                        <label class="form-check-label" for="report_alerts">
                                                            New Report Alerts
                                                        </label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    <div class="form-check form-switch">
                                                        <input class="form-check-input" type="checkbox" id="schedule_alerts" name="schedule_alerts" <?php echo $notification_preferences['schedule_alerts'] ? 'checked' : ''; ?>>
                                                        <label class="form-check-label" for="schedule_alerts">
                                                            Schedule Changes
                                                        </label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    <div class="form-check form-switch">
                                                        <input class="form-check-input" type="checkbox" id="collection_alerts" name="collection_alerts" <?php echo $notification_preferences['collection_alerts'] ? 'checked' : ''; ?>>
                                                        <label class="form-check-label" for="collection_alerts">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form method="POST">
                                                ...
                                                <div class="mb-3">
                                                    <div class="form-check form-switch">
                                                        <input class="form-check-input" type="checkbox" id="auto_assign_reports" name="auto_assign_reports" <?php echo $system_settings['auto_assign_reports'] ? 'checked' : ''; ?>>
                                                        <label class="form-check-label" for="auto_assign_reports">
                                                            Auto-assign reports to available collectors
                                                        </label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    <div class="form-check form-switch">
                                                        <input class="form-check-input" type="checkbox" id="auto_notify_residents" name="auto_notify_residents" <?php echo $system_settings['auto_notify_residents'] ? 'checked' : ''; ?>>
                                                        <label class="form-check-label" for="auto_notify_residents">
                                                            Auto-notify residents of status changes
                                                        </label>
                                                    </div>
                                                </div>
                                                
                                                <hr>
                                                <h6 class="mb-3">Timing Settings</h6>
                                                <div class="row">
                                                    <div class="col-md-6 mb-3">
                                                        <label for="collection_reminder_hours" class="form-label">Collection Reminder (hours before)</label>
                                                        <input type="number" class="form-control" id="collection_reminder_hours" name="collection_reminder_hours" value="<?php echo $system_settings['collection_reminder_hours']; ?>" min="1" max="72">
                                                    </div>
                                                    <div class="col-md-6 mb-3">
                                                        <label for="report_auto_close_days" class="form-label">Auto-close completed reports (days)</label>
                                                        <input type="number" class="form-control" id="report_auto_close_days" name="report_auto_close_days" value="<?php echo $system_settings['report_auto_close_days']; ?>" min="1" max="30">
                                                    </div>
                                                </div>
                                                
                                                <div class="mb-3">
                                                    <label for="max_reports_per_resident" class="form-label">Maximum reports per resident (per month)</label>
                                                    <input type="number" class="form-control" id="max_reports_per_resident" name="max_reports_per_resident" value="<?php echo $system_settings['max_reports_per_resident']; ?>" min="1" max="50">
                                                </div>
                                ...
                                <div class="tab-pane fade" id="backup">
                                    <div class="card">
                                        <div class="card-header">
                                            <h5 class="mb-0"><i class="fas fa-database me-2"></i>Backup & Export</h5>
                                        </div>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-6 mb-4">
                                                    <div class="card border-primary">
                                                        <div class="card-body text-center">
                                                            ...
                                                            <h5>Export Data</h5>
                                                            <p class="text-muted">Download system data in various formats</p>
                                                            <div class="d-grid gap-2">
                                                                <a href="export_reports.php" class="btn btn-outline-primary">
                                                                    <i class="fas fa-file-csv me-2"></i>Export Reports (CSV)
                                                                </a>
                                                                <a href="export_schedules.php" class="btn btn-outline-primary">
                                                                    <i class="fas fa-file-excel me-2"></i>Export Schedules (Excel)
                                                                </a>
                                                                <a href="export_users.php" class="btn btn-outline-primary">
                                                                    <i class="fas fa-file-pdf me-2"></i>Export Users (PDF)
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-6 mb-4">
                                                    <div class="card border-success">
                                                        <div class="card-body text-center">
                                                            ...
                                                            <div class="d-grid gap-2">
                                                                <a href="backup_database.php" class="btn btn-outline-success">
                                                                    <i class="fas fa-save me-2"></i>Create Backup
                                                                </a>
                                                                <a href="restore_database.php" class="btn btn-outline-warning">
                                                                    <i class="fas fa-undo me-2"></i>Restore Backup
                                                                </a>
                                                                <a href="backup_history.php" class="btn btn-outline-info">
                                            ...
                                            <div class="alert alert-info">
                                                ...
                                                <strong>Note:</strong> Database backups are automatically created daily at 2:00 AM. Manual backups are recommended before major system updates.
                                            </div>
                                        </div>
                                    </div>
                                </div>
